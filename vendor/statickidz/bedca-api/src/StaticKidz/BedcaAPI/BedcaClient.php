...
class BedcaClient
{
     ...
     * @return mixed
     */
    public function getFoodEdit($foodId, $rawXML = false)
    {
        $foodGroupXML = BedcaXMLRequests::getFoodEditXML($foodId);
    ...
    public function getFoods($rawXML = false)
    {
        $foodGroupXML = BedcaXMLRequests::getFoodsXML();
